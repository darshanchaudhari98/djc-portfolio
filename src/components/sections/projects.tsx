...
const ProjectsSection = () => {
  return (
    <section id="projects" className="relative z-10 max-w-7xl mx-auto py-20 px-4 overflow-hidden">
      <div className="relative pt-16 mb-8 md:mb-16">
        <div className="absolute inset-0 bg-gradient-to-b from-slate-950/90 via-slate-950/70 to-transparent -z-10 blur-xl scale-150" />
        <Link href={"#projects"}>
          <h2
            className={cn(
              "bg-clip-text text-3xl sm:text-4xl text-center text-transparent md:text-7xl",
          ...
          >
            ...
            <div className="absolute w-full h-1/2 bottom-0 left-0 bg-gradient-to-t from-black via-black/85 to-transparent pointer-events-none">
              <div className="flex flex-col h-full items-start justify-end p-4 md:p-6">
                <div className="text-base md:text-lg text-left">{project.title}</div>
