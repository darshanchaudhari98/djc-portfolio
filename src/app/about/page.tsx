...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "darshanchaudhari9898@gmail.com",
    href: "mailto:darshanchaudhari9898@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/darshan-chaudhari-8076b1200",
    content: "/darshan-chaudhari",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/darshanchaudhari98",
    content: "/darshanchaudhari98",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Darshan Chaudhari</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Darshan, a Fullstack developer passionate about
